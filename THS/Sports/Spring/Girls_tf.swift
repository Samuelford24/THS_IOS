...
import UIKit
import Firebase
class Girls_tf: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var array = [String]()
    
   
    @IBOutlet weak var tableview_gtf: UITableView!
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableview_gtf.dequeueReusableCell(withIdentifier: "cell_gtf")! as UITableViewCell
